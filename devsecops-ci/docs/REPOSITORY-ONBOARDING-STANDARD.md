...
- Repository-urile neidentificate sau neautorizate sunt excluse implicit.
...
scanere, permisiunile sau contractul artefactelor. În repository-ul public se păstrează
numai exemple fictive. Registrul implementărilor reale se menține separat, într-un
spațiu privat autorizat.
